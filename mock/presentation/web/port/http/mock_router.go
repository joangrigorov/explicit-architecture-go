...
// Source: ../internal/presentation/web/port/http/router.go
//
// Generated by this command:
//
//	mockgen -source=../internal/presentation/web/port/http/router.go -destination=presentation/web/port/http/mock_router.go -package=http
//
...
import (
	http "app/internal/presentation/web/port/http"
	reflect "reflect"
