...
// Source: ../internal/presentation/web/infrastructure/framework/validation/rules.go
//
// Generated by this command:
//
//	mockgen -source=../internal/presentation/web/infrastructure/framework/validation/rules.go -destination=presentation/web/infrastructure/framework/validation/mock_rules.go -package=validation
//
