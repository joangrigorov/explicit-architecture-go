...
// Source: ../internal/presentation/api/infrastructure/framework/validation/rules.go
//
// Generated by this command:
//
//	mockgen -source=../internal/presentation/api/infrastructure/framework/validation/rules.go -destination=presentation/api/infrastructure/framework/validation/mock_rules.go -package=validation
//
