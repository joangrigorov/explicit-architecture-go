...
//
//	mockgen -source=../internal/core/component/activity/application/repositories/activity_repository.go -destination=core/component/activity/application/repositories/mock_post_repository.go -package=repositories
//
...
import (
	post "app/internal/core/component/activity/domain"
	context "context"
	reflect "reflect"
...
// MockPostRepository is a mock of activityRepository interface.
...
func (m *MockPostRepository) Create(ctx context.Context, arg1 *post.Activity) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) Delete(ctx context.Context, p *post.Activity) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetAll(ctx context.Context) ([]*post.Activity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx)
	ret0, _ := ret[0].([]*post.Activity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPostRepository) GetById(ctx context.Context, id int) (*post.Activity, error) {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) Update(ctx context.Context, arg1 *post.Activity) error {
	m.ctrl.T.Helper()
