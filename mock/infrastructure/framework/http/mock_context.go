...
// Source: ../internal/presentation/api/port/http/context.go
//
// Generated by this command:
//
//	mockgen -source=../internal/presentation/api/port/http/context.go -destination=presentation/api/port/http/mock_context.go -package=http
//
