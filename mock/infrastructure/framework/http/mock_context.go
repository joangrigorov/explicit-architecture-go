...
// Source: ../internal/infrastructure/framework/http/context.go
//
// Generated by this command:
//
//	mockgen -source=../internal/infrastructure/framework/http/context.go -destination=infrastructure/framework/http/mock_context.go -package=http
//
...
func (m *MockContext) SetResponseHeader(key, val string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetResponseHeader", key, val)
}

// SetResponseHeader indicates an expected call of SetResponseHeader.
func (mr *MockContextMockRecorder) SetResponseHeader(key, val any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetResponseHeader", reflect.TypeOf((*MockContext)(nil).SetResponseHeader), key, val)
}
