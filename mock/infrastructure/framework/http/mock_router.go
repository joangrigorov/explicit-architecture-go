...
// Source: ../internal/infrastructure/framework/http/router.go
//
// Generated by this command:
//
//	mockgen -source=../internal/infrastructure/framework/http/router.go -destination=infrastructure/framework/http/mock_router.go -package=http
//
...
import (
	http "app/internal/infrastructure/framework/http"
	reflect "reflect"
