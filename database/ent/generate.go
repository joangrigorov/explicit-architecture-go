...
//go:generate atlas migrate diff activity --dir "file://../migrations/activity" --to "ent://schema/activities" --dev-url "docker://postgres/17/test?search_path=public"
...
//go:generate atlas migrate diff attendance --dir "file://../migrations/attendance" --to "ent://schema/attendances" --dev-url "docker://postgres/17/test?search_path=public"
...
//go:generate atlas migrate diff user --dir "file://../migrations/user" --to "ent://schema/users" --dev-url "docker://postgres/17/test?search_path=public"
