...
func (pc *PostCreate) check() error {
	if _, ok := pc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`blog: missing required field "Post.name"`)}
	}
	if _, ok := pc.mutation.Content(); !ok {
		return &ValidationError{Name: "content", err: errors.New(`blog: missing required field "Post.content"`)}
	}
	return nil
}
