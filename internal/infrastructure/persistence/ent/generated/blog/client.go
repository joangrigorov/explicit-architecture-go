...
var ErrTxStarted = errors.New("blog: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("blog: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("blog: unknown mutation type %T", m)
	}
}
...
func (c *PostClient) mutate(ctx context.Context, m *PostMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("blog: unknown Post mutation op: %q", m.Op())
	}
}
