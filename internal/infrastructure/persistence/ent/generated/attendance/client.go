...
var ErrTxStarted = errors.New("attendance: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attendance: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("attendance: unknown mutation type %T", m)
	}
}
...
func (c *AttendanceClient) mutate(ctx context.Context, m *AttendanceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("attendance: unknown Attendance mutation op: %q", m.Op())
	}
}
