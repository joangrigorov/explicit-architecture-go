...
func (_c *UserCreate) SetIdpUserID(v string) *UserCreate {
	_c.mutation.SetIdpUserID(v)
	return _c
}

// SetNillableIdpUserID sets the "idp_user_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableIdpUserID(v *string) *UserCreate {
	if v != nil {
		_c.SetIdpUserID(*v)
	}
	return _c
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IdpUserID(); ok {
		_spec.SetField(user.FieldIdpUserID, field.TypeString, value)
		_node.IdpUserID = &value
	}
