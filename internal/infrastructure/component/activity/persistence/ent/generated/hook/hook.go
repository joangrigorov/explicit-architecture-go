...
type ActivityFunc func(context.Context, *generated.ActivityMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ActivityFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
