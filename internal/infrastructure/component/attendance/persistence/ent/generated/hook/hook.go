...
type AttendanceFunc func(context.Context, *generated.AttendanceMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AttendanceFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AttendanceMutation); ok {
		return f(ctx, mv)
	}
